...
<div class="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
    ...
    <div class="animate-fade-in-up flex gap-3">
        <button onclick="openDeliveryModal()" class="flex items-center gap-2 rounded-xl bg-blue-600 px-6 py-3.5 text-sm font-bold text-white hover:bg-blue-700 shadow-lg shadow-blue-500/30 active:scale-95 transition-all">
...
<div id="modalDelivery" class="modal-container strict-overlay hidden items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
...
<div id="trackingModal" class="modal-container strict-overlay hidden items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
...
<div id="detailModal" class="modal-container strict-overlay hidden items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
...
<script>
    ...
    $('#formDelivery').on('submit', function(e) {
        ...
        btn.prop('disabled', true).html('<i class="ph-bold ph-spinner animate-spin text-lg"></i> Processing...');
